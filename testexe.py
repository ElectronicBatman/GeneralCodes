...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pushButton.setGeometry(QtCore.QRect(290, 140, 75, 23))
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self.label = QtGui.QLabel(Form)
        self.label.setGeometry(QtCore.QRect(100, 40, 191, 16))
        self.label.setObjectName(_fromUtf8("label"))
        self.lineEdit = QtGui.QLineEdit(Form)
        self.lineEdit.setGeometry(QtCore.QRect(50, 140, 211, 20))
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Whats Up Bro?", None))
